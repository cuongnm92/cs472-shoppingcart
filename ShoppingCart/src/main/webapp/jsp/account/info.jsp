...
<script src="${contextPath}/resources/js/account/sinfo.js"></script>

<link href="${contextPath}/resources/css/shop-item.css" rel="stylesheet"
	type="text/css" media="all" />
<link href="${contextPath}/resources/css/morris.css" rel="stylesheet"
	type="text/css" media="all" />
<link href="${contextPath}/resources/css/account/info.css" rel="stylesheet"
	type="text/css" media="all" />
		...
		<div class="row">
			...
			<div class="col-lg-3">
				...
				<div class="list-group">
					<a href="${contextPath}/account/summary"
						class="list-group-item active">Summary</a> <a
						href="${contextPath}/account/info" class="list-group-item">Account</a>
					<a href="${contextPath}/product/add" class="list-group-item active">Add
						new product</a>
				</div>
			</div>
			<!-- /.col-lg-3 -->
